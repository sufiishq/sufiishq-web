...
export class AudioService {
    ...
    public timeElapsed: BehaviorSubject<string> = new BehaviorSubject('00:00:00');
    ...
    public playerStatus: BehaviorSubject<string> = new BehaviorSubject('ended');
    ...
    private setTimeElapsed(ct: number): void {
        this.timeElapsed.next(this.getFormattedTime(ct));
    }
    ...
    public getFormattedDuration(): string {
        return this.getFormattedTime(this.audio.duration)
    }
